...
(function($PS) {
          ...
          return function ($copy_t) {
              ...
              function $tco_loop(cs, t) {
                  if (t.value2 instanceof Data_List_Types.Cons && t.value2.value1 instanceof Data_List_Types.Nil) {
                      ...
                      throw new Error("Failed pattern match at Main (line 86, column 14 - line 88, column 36): " + [ v.constructor.name ]);
                  };
                  $tco_done = true;
                  return end(cs)(t);
              };
  ...
  var genericError = {
      to: function (x) {
          ...
          throw new Error("Failed pattern match at Main (line 53, column 1 - line 53, column 48): " + [ x.constructor.name ]);
      },
      from: function (x) {
  ...
  var genericEnd = {
      to: function (x) {
          ...
          throw new Error("Failed pattern match at Main (line 64, column 1 - line 64, column 44): " + [ x.constructor.name ]);
      },
      from: function (x) {
      ...
      var go = function ($copy_s) {
          return function ($copy_done) {
              ...
              function $tco_loop(s, done) {
                  ...
                  throw new Error("Failed pattern match at Main (line 623, column 11 - line 632, column 57): " + [ ml.constructor.name ]);
              };
              while (!$tco_done) {
  ...
  var strToConvertedStr = function (tostr) {
      return function (str) {
          ...
          throw new Error("Failed pattern match at Main (line 445, column 3 - line 448, column 48): " + [ v.constructor.name ]);
      };
  };
  ...
  var strToMappedTree = function (str) {
      return function (f) {
          ...
          throw new Error("Failed pattern match at Main (line 393, column 3 - line 396, column 48): " + [ v.constructor.name ]);
      };
  };
      ...
      return function (str) {
          return function (id) {
              return function ($$default) {
                  ...
                  throw new Error("Failed pattern match at Main (line 429, column 3 - line 432, column 31): " + [ v.constructor.name ]);
              };
          };
      };
  };
  var strToMappedTrees = function (str) {
      return function (f) {
          ...
          throw new Error("Failed pattern match at Main (line 400, column 3 - line 402, column 40): " + [ v.constructor.name ]);
      };
  };
  ...
  var toLaTeX = function (dict) {
          ...
          var go = function (imported) {
              return function (v1) {
                  ...
                  if (v2 instanceof Data_Maybe.Just) {
                      ...
                      throw new Error("Failed pattern match at Main (line 465, column 22 - line 467, column 58): " + [ v3.constructor.name ]);
                  };
                  if (v2 instanceof Data_Maybe.Nothing) {
                      var codeRule = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 472, column 25 - line 474, column 92): " + [ v1.value1.constructor.name ]);
                      })();
                  ...
                  throw new Error("Failed pattern match at Main (line 461, column 13 - line 485, column 69): " + [ v2.constructor.name ]);
              };
          };
      ...
      throw new Error("Failed pattern match at Main (line 456, column 3 - line 485, column 69): " + [ v.constructor.name ]);
  };
  ...
  var subTreeToHTML = function (name) {
      return function (dict) {
                              ...
                              return function (log) {
                                  ...
                                  if (v2 instanceof Data_Maybe.Just) {
                                      ...
                                      return indents + ("<div class='branch'>\x0a" + ((function () {
                                          ...
                                          throw new Error("Failed pattern match at Main (line 513, column 19 - line 542, column 45): " + [ v3.constructor.name ]);
                                      })() + (indents + "</div>\x0a")));
                                  };
                                  if (v2 instanceof Data_Maybe.Nothing) {
                                      return indents + ("<div class='branch'>\x0a" + ((function () {
                                  ...
                                  throw new Error("Failed pattern match at Main (line 507, column 11 - line 560, column 36): " + [ v2.constructor.name ]);
                              };
                          };
                      };
                  };
          ...
          throw new Error("Failed pattern match at Main (line 501, column 3 - line 560, column 36): " + [ v.constructor.name ]);
      };
  };
      ...
      return function (id) {
          return function (dict) {
              ...
              if (v instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Main (line 296, column 7 - line 298, column 170): " + [ v1.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 293, column 3 - line 298, column 170): " + [ v.constructor.name ]);
          };
      };
  };
      ...
      return function (to) {
          return function (dict) {
              ...
              if (v instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Main (line 313, column 9 - line 315, column 136): " + [ v1.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 310, column 5 - line 315, column 136): " + [ v.constructor.name ]);
          };
      };
  };
      ...
      return function (oldtree) {
          var go = function (v) {
              return function (v1) {
                  ...
                  throw new Error("Failed pattern match at Main (line 221, column 5 - line 222, column 59): " + [ v.constructor.name, v1.constructor.name ]);
              };
          };
          return go(Data_Array.toUnfoldable(Data_List_Types.unfoldableList)(ixarr))(oldtree);
      };
          ...
          return Data_List.nub(Data_Ord.ordString)((function () {
              ...
              if (v instanceof Data_Maybe.Just) {
                  var go = function (v1) {
                      ...
                      throw new Error("Failed pattern match at Main (line 386, column 11 - line 388, column 33): " + [ v2.constructor.name ]);
                  };
                  return go(v.value0.tree);
              };
              throw new Error("Failed pattern match at Main (line 381, column 3 - line 388, column 33): " + [ v.constructor.name ]);
          })());
      };
  };
