...
(function($PS) {
  ...
  var removeNthIf = function (v) {
      return function (v1) {
          return function (v2) {
              ...
              throw new Error("Failed pattern match at Main (line 174, column 1 - line 174, column 67): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
  var readComment = function (tree) {
      ...
      var go = function ($copy_cs) {
          return function ($copy_t) {
              ...
              var $tco_done = false;
              var $tco_result;
              function $tco_loop(cs, t) {
                  if (t.value2 instanceof Data_List_Types.Cons && t.value2.value1 instanceof Data_List_Types.Nil) {
                      var l = unsplitLineOnSharp({
                          body: t.value0,
                          rule: t.value1
                      });
                      var v = Data_String_CodeUnits.stripPrefix("//")(l);
                      if (v instanceof Data_Maybe.Just) {
                          $tco_var_cs = new Data_List_Types.Cons(v.value0, cs);
                          $copy_t = t.value2.value0;
                          return;
                      };
                      if (v instanceof Data_Maybe.Nothing) {
                          $tco_done = true;
                      ...
                      throw new Error("Failed pattern match at Main (line 87, column 14 - line 89, column 36): " + [ v.constructor.name ]);
                  };
                  $tco_done = true;
                  return end(cs)(t);
              };
              while (!$tco_done) {
                  $tco_result = $tco_loop($tco_var_cs, $copy_t);
              };
              return $tco_result;
          };
      };
  ...
  var modifyNth = function (i) {
      return function (f) {
          return function (l) {
              ...
              throw new Error("Failed pattern match at Main (line 170, column 3 - line 172, column 17): " + [ v.constructor.name ]);
          };
      };
  };
  ...
  var treesToOriginal = function (dict) {
      return Data_Foldable.intercalate(Data_List_Types.foldableList)(Data_Monoid.monoidString)("\x0a")(Data_List.mapMaybe(function (k) {
          return Data_Functor.map(Data_Maybe.functorMaybe)(function (tc) {
              return toOriginal(tc.tree) + ((function () {
                  var $120 = tc.comment === "";
                  if ($120) {
                      return "";
                  };
                  return Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)("")(Data_Functor.map(Data_Functor.functorArray)(function (v) {
                      return "\x0a//" + v;
                  })(Data_String_Common.split("\x0a")(tc.comment)));
              })() + (function () {
                  var $121 = k === rootname;
                  if ($121) {
                      return "";
      ...
      return function (tree) {
          var go = function (v) {
              return function (v1) {
                  ...
                  throw new Error("Failed pattern match at Main (line 182, column 5 - line 182, column 22): " + [ v.constructor.name, v1.constructor.name ]);
              };
          };
          ...
          return function ($copy_done) {
              ...
              function $tco_loop(s, done) {
                  ...
                  if (ml instanceof Data_Maybe.Just) {
                      var $172 = Data_Eq.eq(Data_String_CodePoints.eqCodePoint)(ml.value0.head)(frc("_"));
                      if ($172) {
                          var $173 = Data_String_CodePoints.length(Data_String_CodePoints.takeWhile(Data_CodePoint_Unicode.isNumber)(ml.value0.tail)) > 0;
                          if ($173) {
                  ...
                  throw new Error("Failed pattern match at Main (line 624, column 11 - line 633, column 58): " + [ ml.constructor.name ]);
              };
              while (!$tco_done) {
      ...
      var go = function (parents) {
          return function (v) {
              ...
              if (v instanceof Data_List_Types.Cons) {
                  ...
                  throw new Error("Failed pattern match at Main (line 136, column 21 - line 138, column 93): " + [ v1.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 123, column 5 - line 123, column 42): " + [ parents.constructor.name, v.constructor.name ]);
          };
      };
      return go(Data_List_Types.Nil.value);
  })();
      ...
      var go = function ($copy_ts) {
          return function ($copy_ls1) {
              ...
              function $tco_loop(ts, ls1) {
                  ...
                  throw new Error("Failed pattern match at Main (line 144, column 9 - line 149, column 59): " + [ v.constructor.name ]);
              };
              while (!$tco_done) {
  ...
  var strToConvertedStr = function (tostr) {
      return function (str) {
          ...
          throw new Error("Failed pattern match at Main (line 446, column 3 - line 449, column 48): " + [ v.constructor.name ]);
      };
  };
  ...
  var strToMappedTree = function (str) {
      return function (f) {
          ...
          throw new Error("Failed pattern match at Main (line 394, column 3 - line 397, column 48): " + [ v.constructor.name ]);
      };
  };
      ...
      var go = function ($copy_lines) {
          return function ($copy_trees) {
              ...
              function $tco_loop(lines, trees) {
                  ...
                  if (v instanceof Data_Either.Right && v.value0.value1 instanceof SubRoot) {
                      var $223 = Data_Map_Internal.member(Data_Ord.ordString)(v.value0.value1.value0)(trees) || v.value0.value1.value0 === rootname;
                      if ($223) {
                          $tco_done = true;
                  ...
                  throw new Error("Failed pattern match at Main (line 102, column 7 - line 111, column 48): " + [ v.constructor.name ]);
              };
              while (!$tco_done) {
      ...
      return function (str) {
          return function (id) {
              return function ($$default) {
                  ...
                  throw new Error("Failed pattern match at Main (line 430, column 3 - line 433, column 31): " + [ v.constructor.name ]);
              };
          };
      };
  };
  var strToMappedTrees = function (str) {
      return function (f) {
          ...
          throw new Error("Failed pattern match at Main (line 401, column 3 - line 403, column 40): " + [ v.constructor.name ]);
      };
  };
              ...
              return function (v) {
                  return Data_String_CodePoints.fromCodePointArray(Control_Bind.bind(Control_Bind.bindArray)(Data_String_CodePoints.toCodePointArray(s))(function (c) {
                      return Data_String_CodePoints.toCodePointArray((function () {
                          var $243 = Data_Eq.eq(Data_String_CodePoints.eqCodePoint)(c)(v.value0);
                          if ($243) {
                              return v.value1;
                          };
  ...
  var replaceForLaTeX = (function () {
      var $458 = escapeWith(ruleLaTeXChars);
      return function ($459) {
          return replaceUnderbarNumToBlaced($458($459));
      };
  })();
  var toLaTeX = function (dict) {
          ...
          var go = function (imported) {
              return function (v1) {
                  ...
                  if (v2 instanceof Data_Maybe.Just) {
                      var $250 = Data_Foldable.elem(Data_List_Types.foldableList)(Data_Eq.eqString)(v2.value0)(imported);
                      if ($250) {
                      ...
                      throw new Error("Failed pattern match at Main (line 466, column 22 - line 468, column 58): " + [ v3.constructor.name ]);
                  };
                  if (v2 instanceof Data_Maybe.Nothing) {
                      var codeRule = (function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 473, column 25 - line 475, column 94): " + [ v1.value1.constructor.name ]);
                      })();
                  ...
                  throw new Error("Failed pattern match at Main (line 462, column 13 - line 486, column 69): " + [ v2.constructor.name ]);
              };
          };
      ...
      throw new Error("Failed pattern match at Main (line 457, column 3 - line 486, column 69): " + [ v.constructor.name ]);
  };
  ...
  var subTreeToHTML = function (name) {
      return function (dict) {
                      ...
                      return function (indents) {
                          return function (ids) {
                              return function (log) {
                                  var v2 = isImport(v1.value0);
                                  if (v2 instanceof Data_Maybe.Just) {
                                      var $268 = Data_Foldable.elem(Data_List_Types.foldableList)(Data_Eq.eqString)(v2.value0)(imported);
                                      if ($268) {
                                      ...
                                      return indents + ("<div class='branch'>\x0a" + ((function () {
                                          ...
                                          throw new Error("Failed pattern match at Main (line 514, column 19 - line 543, column 46): " + [ v3.constructor.name ]);
                                      })() + (indents + "</div>\x0a")));
                                  };
                                  if (v2 instanceof Data_Maybe.Nothing) {
                                      return indents + ("<div class='branch'>\x0a" + ((function () {
                                          var $276 = Data_List.length(v1.value2) > 0;
                                          if ($276) {
                                  ...
                                  throw new Error("Failed pattern match at Main (line 508, column 11 - line 561, column 37): " + [ v2.constructor.name ]);
                              };
                          };
                      };
                  };
          ...
          throw new Error("Failed pattern match at Main (line 502, column 3 - line 561, column 37): " + [ v.constructor.name ]);
      };
  };
  ...
  var getSubTrees = function (s) {
      return Data_Either.either(Data_Function["const"]([  ]))((function () {
          var $460 = Data_Array.fromFoldable(Data_List_Types.foldableList);
          return function ($461) {
              return $460(getTreesName_rootFirst($461));
          };
      })())(parseFromStrToTrees(s));
  };
      ...
      return function (oldtree) {
          var go = function (v) {
              return function (v1) {
                  ...
                  throw new Error("Failed pattern match at Main (line 272, column 5 - line 272, column 34): " + [ v.constructor.name, v1.constructor.name ]);
              };
          };
      ...
      return function (oldtree) {
          var go = function (v) {
              return function (v1) {
                  ...
                  throw new Error("Failed pattern match at Main (line 253, column 5 - line 253, column 35): " + [ v.constructor.name, v1.constructor.name ]);
              };
          };
          return go(Data_Array.toUnfoldable(Data_List_Types.unfoldableList)(ixarr))(oldtree);
      };
                  ...
                  return function (v1) {
                      return function (v2) {
                          ...
                          if (v instanceof Data_List_Types.Nil) {
                              ...
                              var $315 = Data_List["null"](v2.value2) && Data_String_CodeUnits.contains("\x0a")(v1);
                              if ($315) {
                                  ...
                                  throw new Error("Failed pattern match at Main (line 209, column 13 - line 212, column 33): " + [ v3.constructor.name ]);
                              };
                              return $$default;
                          };
                          if (v instanceof Data_List_Types.Cons) {
                          ...
                          throw new Error("Failed pattern match at Main (line 198, column 5 - line 203, column 24): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
                      };
                  };
              };
              ...
              var go = function (v) {
                  return function (nb) {
                      return function (v1) {
                          ...
                          throw new Error("Failed pattern match at Main (line 188, column 5 - line 188, column 21): " + [ v.constructor.name, nb.constructor.name, v1.constructor.name ]);
                      };
                  };
              };
  ...
  var _tryMakeNewSubTree = function (tree) {
      return function (dict) {
          ...
          var go = function ($copy_i) {
              ...
              var $tco_result;
              function $tco_loop(i) {
                  var $339 = Data_Map_Internal.member(Data_Ord.ordString)(name(i))(dict);
                  if ($339) {
                      $copy_i = i + 1 | 0;
                      return;
                  };
  ...
  var _tryMakeEmptySubTree = (function () {
      var $462 = _tryMakeNewSubTree(new Node("", Data_Maybe.Nothing.value, Data_List_Types.Nil.value));
      return function ($463) {
          return Data_Tuple.snd($462($463));
      };
  })();
      ...
      return function (id) {
          return function (dict) {
              ...
              if (v instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Main (line 297, column 7 - line 299, column 171): " + [ v1.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 294, column 3 - line 299, column 171): " + [ v.constructor.name ]);
          };
      };
  };
      ...
      return function (oldtree) {
          var go = function (v) {
              return function (v1) {
                  ...
                  throw new Error("Failed pattern match at Main (line 263, column 5 - line 264, column 36): " + [ v.constructor.name, v1.constructor.name ]);
              };
          };
          return go(Data_Array.toUnfoldable(Data_List_Types.unfoldableList)(ixarr))(oldtree);
      };
          ...
          return function (oldtree) {
              var go = function (v) {
                  return function (v1) {
                      ...
                      throw new Error("Failed pattern match at Main (line 240, column 5 - line 240, column 17): " + [ v.constructor.name, v1.constructor.name ]);
                  };
              };
              return go(Data_Array.toUnfoldable(Data_List_Types.unfoldableList)(ixarr))(oldtree);
          };
              ...
              if (v instanceof Data_Maybe.Just) {
                  ...
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return _tryApplyToAllTrees(function (b) {
                          var $397 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqString))(isImport(b))(new Data_Maybe.Just(from));
                          if ($397) {
                              return "$" + to;
                          };
                          return b;
                  ...
                  throw new Error("Failed pattern match at Main (line 314, column 9 - line 316, column 137): " + [ v1.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 311, column 5 - line 316, column 137): " + [ v.constructor.name ]);
          };
      };
  };
      ...
      return function (oldtree) {
          var go = function (v) {
              return function (v1) {
                  ...
                  throw new Error("Failed pattern match at Main (line 222, column 5 - line 223, column 60): " + [ v.constructor.name, v1.constructor.name ]);
              };
          };
          return go(Data_Array.toUnfoldable(Data_List_Types.unfoldableList)(ixarr))(oldtree);
      };
      ...
      return function (oldtree) {
          var go = function (v) {
              return function (v1) {
                  ...
                  throw new Error("Failed pattern match at Main (line 231, column 5 - line 232, column 44): " + [ v.constructor.name, v1.constructor.name ]);
              };
          };
          return go(Data_Array.toUnfoldable(Data_List_Types.unfoldableList)(ixarr))(oldtree);
      };
  ...
  var _getDependency = function (name) {
      return function (dict) {
          return Data_List.nub(Data_Ord.ordString)((function () {
              var v = Data_Map_Internal.lookup(Data_Ord.ordString)(name)(dict);
              if (v instanceof Data_Maybe.Nothing) {
                  return Data_List_Types.Nil.value;
              };
              if (v instanceof Data_Maybe.Just) {
                  var go = function (v1) {
                      var v2 = isImport(v1.value0);
                      if (v2 instanceof Data_Maybe.Just) {
                          return Data_Semigroup.append(Data_List_Types.semigroupList)(_getDependency(v2.value0)(dict))(Data_List.singleton(v2.value0));
                      };
                      if (v2 instanceof Data_Maybe.Nothing) {
                          return Control_Bind.bindFlipped(Data_List_Types.bindList)(go)(v1.value2);
                      };
                      throw new Error("Failed pattern match at Main (line 387, column 11 - line 389, column 33): " + [ v2.constructor.name ]);
                  };
                  return go(v.value0.tree);
              };
              throw new Error("Failed pattern match at Main (line 382, column 3 - line 389, column 33): " + [ v.constructor.name ]);
          })());
      };
  };
  var getDependency = function (s) {
      return function (t) {
          return Data_Either.either(Data_Function["const"]([  ]))(function (dict) {
              return Data_Array.fromFoldable(Data_List_Types.foldableList)(_getDependency(t)(dict));
          })(parseFromStrToTrees(s));
      };
  };
  ...
  exports["_getDependency"] = _getDependency;
