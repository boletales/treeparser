...
(function($PS) {
  ...
  var root = function (children) {
      return function (reason) {
          return function (ls) {
              ...
              if (children instanceof Data_List_Types.Cons && children.value1 instanceof Data_List_Types.Nil) {
                  return Data_Either.Right.create(new Closed(children.value0, reason, ls));
              };
  ...
  var readTree = (function () {
      var go = function (children) {
          return function (v) {
              if (v instanceof Data_List_Types.Nil) {
                  return root(children)(EOT.value)(Data_List_Types.Nil.value);
              };
              if (v instanceof Data_List_Types.Cons) {
                  if (v.value0 === "{") {
                      return Control_Bind.bind(Data_Either.bindEither)(readSubTrees(v.value1))(function (result) {
                          return go(result.children)(result.leftstr);
                      });
                  };
                  if (v.value0 === ",") {
                      return root(children)(Comma.value)(v.value1);
                  };
                  if (v.value0 === "}") {
                      return root(children)(Close.value)(v.value1);
                  };
  ...
  var readSubTrees = function (ls) {
      ...
      return Data_Functor.map(Data_Either.functorEither)(function (v) {
          return {
              children: Data_List.reverse(v.value0),
              leftstr: v.value1
          };
      })(go(Data_List_Types.Nil.value)(ls));
  };
  var parseFromStr = function (str) {
  ...
  var toLaTeX = function (tree) {
      var go = function (v) {
          ...
          var codeBody = (function () {
              var v1 = Data_List.length(v.value2);
              if (v1 === 0) {
          ...
          return Data_List.concat(new Data_List_Types.Cons(codeChildren, new Data_List_Types.Cons(codeRule, new Data_List_Types.Cons(codeBody, Data_List_Types.Nil.value))));
      };
      return "\\begin{prooftree}\x0a" + (Data_Foldable.intercalate(Data_List_Types.foldableList)(Data_Monoid.monoidString)("\x0a")(go(tree)) + "\x0a\\end{prooftree}");
  };
  var strToLaTeX = strToConvertedStr(toLaTeX);
  var toHTML = function (tree) {
      var go = function (v) {
          return function (indents) {
              return function (ids) {
      ...
      return go(tree)("")(Data_List_Types.Nil.value);
  };
  var strToHTML = strToConvertedStr(toHTML);
  var _tryrewriteTreeWithIndex = function (oldtree) {
  ...
  var tryrewriteTreeWithIndex = function (s) {
      return function (i) {
          return function (b) {
  ...
  var tryDelWithIndex = function (s) {
      return function (i) {
          return function (f) {
              return strToMappedTree(s)(function (t) {
                  return _tryDelWithIndex(t)(i)(f);
              });
          };
      };
  };
  var _tryAddParentRightWithIndex = function (oldtree) {
      return function (ixarr) {
          var go = function (v) {
              return function (v1) {
                  if (v instanceof Data_List_Types.Nil) {
  ...
  var tryAddParentRightWithIndex = function (s) {
      return function (i) {
          return strToMappedTree(s)(function (t) {
              return _tryAddParentRightWithIndex(t)(i);
          });
      };
  };
  var _tryAddParentLeftWithIndex = function (oldtree) {
      return function (ixarr) {
          var go = function (v) {
              return function (v1) {
                  if (v instanceof Data_List_Types.Nil) {
  ...
  var tryAddParentLeftWithIndex = function (s) {
      return function (i) {
          return strToMappedTree(s)(function (t) {
  ...
  var killEmptySubTrees = function (s) {
      return strToMappedTree(s)(_killEmptySubTrees);
  };
  var _isAxiom = function (tree) {
      return function (ixarr) {
          var go = function (v) {
              return function (v1) {
                  if (v instanceof Data_List_Types.Nil && v1.value2 instanceof Data_List_Types.Nil) {
                      return true;
                  };
                  if (v instanceof Data_List_Types.Nil) {
                      return false;
  ...
  var _countChildren = function (tree) {
      return function (ixarr) {
          var go = function (v) {
              return function (v1) {
                  if (v instanceof Data_List_Types.Nil) {
                      return Data_List.length(v1.value2);
                  };
                  if (v instanceof Data_List_Types.Cons) {
  ...
  var countChildren = function (s) {
      return function (i) {
          return strToConvertedA(function (t) {
              return _countChildren(t)(i);
          })(s)(0);
      };
  };
  ...
  var addChild = function (s) {
      return strToMappedTree(s)(_addChild);
  };
  exports["main"] = main;
  ...
  exports["readSubTrees"] = readSubTrees;
  ...
  exports["parseFromStr"] = parseFromStr;
  exports["frc"] = frc;
  exports["fsc"] = fsc;
